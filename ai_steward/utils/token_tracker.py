# guardian_angel/utils/tolen_tracker.py
# 
# Modified based on ai_scientist/utils/tolen_tracker.py from AI-Scientist-v2
...
def track_token_usage(func):
    ...
    def sync_wrapper(*args, **kwargs):
        ...
        if (
            ...
            result.usage and
            hasattr(result.usage, "completion_tokens_details") and
            result.usage.completion_tokens_details and
            hasattr(result.usage.completion_tokens_details, "reasoning_tokens")
        ):
            token_tracker.add_tokens(
                model,
                result.usage.prompt_tokens,
